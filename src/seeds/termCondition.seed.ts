...
export default class TermConditionSeeder implements Seeder {
  async run(
    ...
    const termsConditionsData = `
      ...
      Bem-vindo(a). Ao utilizar nosso site e serviços, você concorda com os seguintes termos e condições:
      ...
      2. Conteúdo do Usuário
        ...
        2.2. Não é permitido publicar conteúdo que seja ilegal, ofensivo ou que viole direitos de terceiros.
      ...
      5. Contato
        5.1. Se você tiver qualquer dúvida sobre estes termos, entre em contato conosco pelo e-mail suporte@main.com.
